...
A second line appears below the first, in my own voice — **no quotation marks**, visually emphasized (bolder, different color, or just the absence of quotes making it stand out):
...
Same line-break structure as the original quote — the rhythm should match.
